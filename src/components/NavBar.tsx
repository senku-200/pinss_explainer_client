...
const NavBar: React.FC = () => {
  return (
    <header className="fixed top-0 left-0 flex items-center w-full h-20 justify-between px-10 border-b-2 border-gray-200 bg-white z-50">
      <nav>
        <h1
          className="text-3xl font-extrabold tracking-tight bg-clip-text text-transparent select-none"
          style={{
