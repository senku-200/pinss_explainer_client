...
const PINNsExplainer: React.FC = () => (
    <section className="max-w-3xl mx-auto my-12 p-6 bg-white rounded">
        ...
        {renderBlockMath("\\frac{dN}{dt} + \\lambda N = 0")}
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="mb-4">
                ...
                {renderBlockMath("N(t) = N_0 e^{-\\lambda t}")}
                <p className="text-sm text-gray-600 max-w-2xl mx-auto mb-2">
                    This gives the exact value of {renderInlineMath("N(t)")} at any time{" "}
                    {renderInlineMath("t")}, starting from initial value{" "}
                    {renderInlineMath("N_0")}.
                </p>
            </div>
            <div className="mb-4">
                <span className="font-semibold text-gray-700">Long-Time Limit:</span>
                {renderBlockMath("\\lim_{t \\to infty} N(t) = 0")}
                <p className="text-sm text-gray-600 max-w-2xl mx-auto mb-2">
            ...
            <p className="mb-4 text-justify max-w-2xl">
                ...
                It penalizes the network if its output {renderInlineMath("N(t)")} does
                not satisfy {renderInlineMath("\\frac{dN}{dt} = -\\lambda N")} at
